...
import com.android.systemui.aicp.header.StatusBarHeaderMachine;
...
public class QSContainerImpl extends FrameLayout implements
    ...
    private static final String STATUS_BAR_CUSTOM_HEADER_SHADOW =
            "system:" + Settings.System.OMNI_STATUS_BAR_CUSTOM_HEADER_SHADOW;
    ...
    private boolean mQsSBBackgroundGradient = false;
